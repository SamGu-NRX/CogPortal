# Week 3 capstone: Semantic Image Search (Language module)
...
- [Language/SemanticImageSearch.html — Language Module Capstone: Semantic Image Search](https://rsokl.github.io/CogWeb/Language/SemanticImageSearch.html)
- [language.html — Language Module index](https://rsokl.github.io/CogWeb/language.html)
...
![margin ranking loss](media/nlp-cap-intro-search.png)
...
![Overview of data](media/nlp-cap-data.png)
...
![Creating an embedding for text](media/nlp-cap-text.png)
...
![Model for mapping an image descriptor to an embedding](media/nlp-cap-model.png)
...
![The training process](media/nlp-cap-training.png)
...
![The searching process](media/nlp-cap-searching.png)
